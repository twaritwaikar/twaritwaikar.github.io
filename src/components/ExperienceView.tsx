...
export const ExperienceView: React.FC<ExperienceViewProps> = ({
  ...
  return (
    <div id="experience_view_container" className="h-full min-h-0 flex flex-col gap-3 max-w-[1280px] mx-auto overflow-hidden">
        ...
        <div className="space-y-2 overflow-y-auto min-h-0 pr-1">
          {experience.map((exp) => (
            <button
              ...
              className={`w-full text-left grid grid-cols-1 sm:grid-cols-12 gap-2 sm:gap-4 p-3 border border-transparent hover:border-[#5CE883] cursor-pointer transition-colors ${
            ...
            >
              ...
              <div className="sm:col-span-9 space-y-1 min-w-0">
                <h3
